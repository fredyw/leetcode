...
fun main() {
    ...
    println(prob.getLastMoment(5, intArrayOf(9), intArrayOf(2, 7))) // 5
    println(prob.getLastMoment(9, intArrayOf(9), intArrayOf(2, 7))) // 9
    println(prob.getLastMoment(9, intArrayOf(4, 9), intArrayOf(2, 7))) // 9
    ...
    println(prob.getLastMoment(9, intArrayOf(1, 3), intArrayOf(5, 9))) // 4
}
...
class Problem2231 {
    fun largestInteger(num: Int): Int {
        ...
        val sortedOddIndexes =
            oddIndexes.sortedWith(Comparator { a, b -> numString[b].compareTo(numString[a]) })
        val sortedEvenIndexes =
            evenIndexes.sortedWith(Comparator { a, b -> numString[b].compareTo(numString[a]) })

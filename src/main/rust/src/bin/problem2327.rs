...
pub fn people_aware_of_secret(n: i32, delay: i32, forget: i32) -> i32 {
    fn f(n: i32, delay: i32, forget: i32, day: i32, memo: &mut Vec<i64>) -> i64 {
        if day > n {
            return 0;
        }
        let secret_day = day + delay;
        if memo[secret_day as usize] != -1 {
            return memo[secret_day as usize];
        }
        ...
        memo[secret_day as usize] = sum;
        sum
    }

    let mut memo = vec![-1i64; (n + delay + 1) as usize];
